...
//foreach(goodslist) insertinto db('order_id','open_id','goods_id','count','size','color')
//invoke wxpay 获取prepay_id签名 
//将prepay_id sign dejson发给前端小程序拉起支付
//支付完成 获取支付状态，如果成功将订单状态信息等发给前端
...
class Wx_pay extends CI_Controller {
    ...
    public function pay(){
        ...
        $openid = 'opexV44i7VE09QFeUIzZ2mYgGVqc';
        $mch_id='1525232981';
        $key='KKElrCci5h6ZrEjrRaCJ6c8IKeAnhLoG';
